...
Project-agnostic Hermes Kanban reporting utilities that turn real board data into validated JSON and operational PDF reports.

The package is intentionally neutral: board slugs, project labels, repositories, CI workflows, artifacts, and delivery targets are passed as runtime configuration rather than hardcoded into schemas or rendering logic.
